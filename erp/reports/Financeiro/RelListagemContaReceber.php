...
$query = " SELECT ct.CD_CONTA,ct.CD_PARCELA,ct.DS_CONTA_RECEBER,ct.CD_PESSOA,p.NM_PESSOA,
...
$PHPJasperXML->arrayParameter=array("P_NM_LOGIN"=>$_SESSION['NM_LOGIN']
								   ,"P_TITULO"=>"Relatório de Contas a Receber"
								   ,"P_PARAMETROS"=>$parametros
								   ,"P_SQL_QUERY"=>$query);
$PHPJasperXML->load_xml_file('RelListagemContaReceber.jrxml');
