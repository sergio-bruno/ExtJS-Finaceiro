Ext.define('erp.view.Financeiro.BaixaContaPagar.GridContaPagar', {

    extend: 'Ext.grid.Panel',
    alias: 'widget.telaBaixaContaPagar_gridContaPagar',
	border: false,

    initComponent: function(){

		var store = 'Financeiro.BaixaContaPagar.ContaPagarStore'; 
