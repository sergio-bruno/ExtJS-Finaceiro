Ext.define('erp.view.Financeiro.BaixaContaReceber.TelaBaixaContaReceber', {
    extend: 'Ext.Panel',
	alias: 'widget.telaBaixaContaReceber',
	layout: {
		type: 'vbox',
		align : 'stretch',
		pack  : 'start'
	...
	border: false,
	autoScroll: true,
	title: 'Baixa Rápida de Contas a Receber',
	tbar: [
		{
	...
	items: [
		...
		{
			xtype : "telaBaixaContaReceber_gridContaReceber",
