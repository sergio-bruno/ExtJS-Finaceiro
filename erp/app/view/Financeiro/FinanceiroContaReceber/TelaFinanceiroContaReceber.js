Ext.define('erp.view.Financeiro.FinanceiroContaReceber.TelaFinanceiroContaReceber', {
    extend: 'Ext.Panel',
	alias: 'widget.telaFinanceiroContaReceber',
	layout: {
		type: 'vbox',
		align : 'stretch',
		pack  : 'start'
	...
	border: false,
	autoScroll: true,
	title: 'Movimentação de Contas a Receber',
	tbar: [
		{
			itemId: 'btnNovoContaReceber',
			text: 'Nova Conta',
		...
		'-',
		{
			itemId: 'btnEditarContaReceber',
			tooltip: '<b>Editar uma conta selecionada na lista</b>',
			iconCls: 'edit_16'
		},
		{
			itemId: 'btnExcluirContaReceber',
	...
	items: [
		{
			xtype: 'panel',
			itemId: 'panPesquisaContaReceber',
			layout: 'absolute',
			height: 62,
			border: false,
			//hidden: true,
			items: [
				{
					...
					itemId : "edtDsContaReceberPesquisa",
					width: 250,
					labelWidth: 50
				},			
		...
		{
			xtype : "telaFinanceiroContaReceber_gridContaReceber",
			itemId: 'gridContaReceber',
			flex: 1
		}	
	 ]
});