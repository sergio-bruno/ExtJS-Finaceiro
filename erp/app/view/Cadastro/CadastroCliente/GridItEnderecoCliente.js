Ext.define('erp.view.Cadastro.CadastroCliente.GridItEnderecoCliente', {

    extend: 'Ext.grid.Panel',
    alias: 'widget.telaCadastroClienteEdit_gridItEnderecoCliente',
	//border: false,
    ...
    initComponent: function(){
		...
		var store = 'Cadastro.CadastroCliente.EnderecoClienteStore'; 
