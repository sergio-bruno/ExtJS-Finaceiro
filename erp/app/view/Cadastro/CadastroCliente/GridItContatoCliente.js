Ext.define('erp.view.Cadastro.CadastroCliente.GridItContatoCliente', {

    extend: 'Ext.grid.Panel',
    alias: 'widget.telaCadastroClienteEdit_gridItContatoCliente',
	//border: false,
    ...
    initComponent: function(){
		...
		var store = 'Cadastro.CadastroCliente.ContatoClienteStore'; 
