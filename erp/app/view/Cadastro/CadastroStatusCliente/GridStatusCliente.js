Ext.define('erp.view.Cadastro.CadastroStatusCliente.GridStatusCliente', {

    extend: 'Ext.grid.Panel',
    alias: 'widget.telaCadastroStatusCliente_gridStatusCliente',
	border: false,
    ...
    initComponent: function(){
		...
		var store = 'Cadastro.CadastroStatusCliente.StatusClienteStore'; 
