Ext.define('erp.view.Cadastro.CadastroClassificacao.GridClassificacao', {

    extend: 'Ext.grid.Panel',
    alias: 'widget.telaCadastroClassificacao_gridClassificacao',
	border: false,
    ...
    initComponent: function(){
		...
		var store = 'Cadastro.CadastroClassificacao.ClassificacaoStore'; 
