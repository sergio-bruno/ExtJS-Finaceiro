Ext.define('erp.view.Cadastro.CadastroTipoEndereco.GridTipoEndereco', {

    extend: 'Ext.grid.Panel',
    alias: 'widget.telaCadastroTipoEndereco_gridTipoEndereco',
	border: false,
    ...
    initComponent: function(){
		...
		var store = 'Cadastro.CadastroTipoEndereco.TipoEnderecoStore'; 
