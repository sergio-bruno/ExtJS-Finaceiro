Ext.define('erp.view.Cadastro.CadastroPessoa.GridItEnderecoPessoa', {

    extend: 'Ext.grid.Panel',
    alias: 'widget.telaCadastroPessoaEdit_gridItEnderecoPessoa',
	//border: false,
    ...
    initComponent: function(){
		...
		var store = 'Cadastro.CadastroPessoa.EnderecoPessoaStore'; 
